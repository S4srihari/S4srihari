...
-  [**Digital Image Tampering Detection**](https://github.com/S4srihari/Digital-Image-Tampering-Detection) — Web-based CNN model for verifying image authenticity and detecting manipulated regions.
